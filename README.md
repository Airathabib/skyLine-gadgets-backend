...
profile
Qwen3-Max
Вот обновлённый файл server/README.md с учётом всех твоих изменений:
...
1
DATABASE_URL=postgresql://username:password@localhost:5432/skyline_gadgets
Запустите сервер:
bash
...
БД не создаётся автоматически — убедитесь, что база существует в PostgreSQL
Чтобы инициализировать данные, выполните вручную:
bash
